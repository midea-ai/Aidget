...
def train(hyp, opt, device, tb_writer=None):
    ...
    # @kwx
    import copy
    from mslim.algorithms.pytorch.prune.Resrep_pruner import ResRep, calculate_model_flops, Resrep_2, Resrep_1
    ...
    logger.info('original flops: ', ResRep_object.original_flops)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        num_images = dataloader.sampler.__len__()

        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------


            # @kwx
            model, iteration, compactor_mask_dict = Resrep_1(opt, iteration, model, ResRep_object, epoch, num_images, logger, device)
...
if __name__ == '__main__':
    ...
    # @kwx
    parser.add_argument('--lasso_strength', type=float, default=1e-4)
    parser.add_argument('--begin_granularity', type=int, default=4)
    parser.add_argument('--flops_target', type=float, default=0.85)
    parser.add_argument('--print_freq', type=int, default=200)
    parser.add_argument('--num_at_least', type=int, default=1)
